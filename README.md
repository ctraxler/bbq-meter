...
#command for running the device code from the root folder of the project
node bbq-meter/bbq-controller-gateway.js -F config/bbq-controller-thing-config.json -f ./certs 
